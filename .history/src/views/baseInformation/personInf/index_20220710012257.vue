    ...
    >
      ...
      >
        <el-form-item label="头像:" prop="date">
          <el-input v-model="addInfo.date" placeholder="请输入头像"></el-input>
        </el-form-item>
        <el-form-item label="姓名:" prop="name">
          <el-select v-model="addInfo.name" placeholder="请选择">
            <el-option
        ...
        <el-form-item label="鸽笼号:" prop="phoneNu'm">
          <el-input
            v-model="addInfo.phoneNu'm"
            placeholder="请输入鸽笼号"
          ></el-input>
        </el-form-item>
      </el-form>
...
export default defineComponent({
  ...
  setup() {
    ...
    const formRules = ref({
      ...
      phoneNu'm: [{ message: "请输入鸽笼号", trigger: "blur", required: true }],
    });
    // 设置默认头像段，组件内默认半年
    let end = new Date();
    let start = new Date();
