  ...
  <div class="container">
    ...
    <el-main class="main">
      <scTable :data="tableData" stripe highlightCurrentRow>
        ...
        <el-table-column prop="sex" label="拥有权限" width="150" align="center" />
    ...
    >
      ...
      >
        ...
        <el-form-item label="拥有权限:" prop="sex" style="width: 200px">
          <el-select
            v-model="addInfo.sex"
            placeholder="请选择"
          >
...
export default defineComponent({
  ...
  setup() {
    ...
    const formRules = ref({
      ...
      sex:[{ message: "请输入拥有权限", trigger: "blur", required: true }],
