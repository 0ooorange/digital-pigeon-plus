<template>
  <div class="container">
    <div class="tag">
      <el-button type="primary" plain @click="addAdialog = true"
        >添加角色</el-button
      >
      <table-search
    ...
    >
      ...
      <span class="dialog-footer">
        <el-button @click="addAdialog = false">取 消</el-button>
        <el-button type="primary" plain @click="addA()">确 定</el-button>
      </span>
    </el-dialog>
    <el-dialog
      title="编辑员工"
    ...
    >
      ...
      <span class="dialog-footer">
        ...
        <el-button type="primary" plain @click="updateA()">确 定</el-button>
      </span>
    </el-dialog>
  </div>
</template>
...
export default defineComponent({
  ...
  setup() {
    ...
    let addAdialog = ref(false);
    let editADialog = ref(false);
