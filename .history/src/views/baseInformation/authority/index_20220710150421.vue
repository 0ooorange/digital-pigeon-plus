  ...
  <div class="container">
    ...
    <el-main class="main">
      <scTable :data="tableData" stripe highlightCurrentRow>
        ...
        <el-table-column prop="authority" label="拥有权限" width="150" align="center" />
    ...
    >
      ...
      >
        ...
        <el-form-item label="拥有权限:" prop="authority" style="width: 200px">
          <el-select
            v-model="addInfo.authority"
            placeholder="请选择"
          >
            <el-option
...
export default defineComponent({
  ...
  setup() {
    ...
    const formRules = ref({
      ...
      authority:[{ message: "请输入拥有权限", trigger: "blur", required: true }],
