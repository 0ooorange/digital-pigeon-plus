  ...
  <div class="container">
    ...
    <el-main class="main">
      <scTable :data="tableData" stripe highlightCurrentRow>
        ...
        <el-table-column prop="aut" label="拥有权限" width="150" align="center" />
    ...
    >
      ...
      >
        ...
        <el-form-item label="拥有权限:" prop="aut" style="width: 200px">
          <el-select
            v-model="addInfo.aut"
            placeholder="请选择"
          >
...
export default defineComponent({
  ...
  setup() {
    ...
    const formRules = ref({
      ...
      aut:[{ message: "请输入拥有权限", trigger: "blur", required: true }],
