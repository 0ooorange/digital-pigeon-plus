...
export default defineComponent({
  ...
  setup() {
    ...
    const numChange=(index)=>{
      addInfo.weight[index]=parseInt(addInfo.number[index])*parseInt(addInfo.specs[index]);
    }
    const editSpecsChange=()=>{
      if(editInfo.cate[index]==="鸽料138"){
        editInfo.specs[index]="80kg/包"
      }
      else if(editInfo.cate[index]==="中粮"){
        editInfo.specs[index]="40kg/包"
      }
    }
    const formRules = ref({
