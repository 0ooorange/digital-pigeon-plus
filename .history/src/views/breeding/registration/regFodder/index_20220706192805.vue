<template>
  <div class="container">
    <div class="tag">
      <el-button type="primary" plain @click="addFdialog = true"
        >添加饲料</el-button
      >
      <table-search
    ...
    <el-main class="main">
      <scTable :data="tableData" stripe highlightCurrentRow>
        ...
        <el-table-column
          ...
          align="center"
        />
        <el-table-column prop="cate" label="饲料种类" width="120" align="center" />
        <el-table-column
          prop="specs"
          label="规格"
          width="120"
    ...
    >
      ...
      >
        ...
        <el-form-item label="饲料种类:" prop="cate">
          <el-input v-model="addInfo.cate" placeholder="请输入饲料种类"></el-input>
        </el-form-item>
        <el-form-item label="规格:" prop="specs">
          <el-input
            v-model="addInfo.specs"
            placeholder="请输入规格"
          ></el-input>
        </el-form-item>
    ...
    >
      ...
      <span class="dialog-footer">
        ...
        <el-button type="primary" plain @click="updateF()"
          >确 定</el-button
        >
      </span>
    </el-dialog>
...
export default defineComponent({
  ...
  setup() {
    ...
    let addFdialog = ref(false);
    let Fdialog = ref(false);
