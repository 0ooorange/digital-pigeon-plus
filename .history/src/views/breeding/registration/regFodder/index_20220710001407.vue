  ...
  <div class="container">
    ...
    >
      ...
      >
        ...
        <el-form-item label="饲料种类:" prop="cate">
          <el-row :gutter="10">
            <el-col
              ...
              :key="index"
            >
              <el-select v-model="addInfo.cate[index].value" placeholder="请选择">
                <el-option
        ...
        <el-form-item label="规格:" prop="specs" :rules="formRules.cate[index].specs">
          <el-row :gutter="10">
            <el-col
              :span="8"
              v-for="(item, index) in addInfo.cate[index]"
              :key="index"
            >
              <el-input
...
export default defineComponent({
  ...
  setup() {
    ...
    const formRules = ref({
      ...
      cate: [[{ message: "请输入饲料种类", trigger: "blur", required: true }],[{ message: "请输入饲料种类", trigger: "blur", required: true }]],
