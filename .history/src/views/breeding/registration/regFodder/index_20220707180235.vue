<template>
  <div class="container">
    ...
    <el-dialog
      ...
      style="display:flex"
    >
      <el-form :model="addInfo" ref="addRef" label-width="auto"  style="width:400px">
        <el-form-item label="时间:" prop="date" >
          <el-input v-model="addInfo.date" placeholder="请输入时间"></el-input>
        </el-form-item>
          <el-form-item label="饲料种类:" prop="cate">
            <el-row :gutter="10">
          <el-col :span="8" v-for="(item,index) in addInfo.cate" :key="index">
        ...
        <el-form-item label="规格:" prop="specs" >
          <el-row :gutter="10">
          <el-col :span="8" v-for="(item,index) in addInfo.specs" :key="index">
          <el-input v-model="addInfo.specs[index]" placeholder="请输入规格"></el-input>
          </el-col></el-row>
        </el-form-item>
        <el-form-item label="数量:" prop="number">
          <el-row :gutter="10">
          <el-col :span="8" v-for="(item,index) in addInfo.number" :key="index">
        ...
        <el-form-item label="重量:" prop="weight">
          <el-row :gutter="10">
          <el-col :span="8" v-for="(item,index) in addInfo.weight" :key="index">
    ...
    >
      <el-form :model="editInfo" ref="editRef" label-width="auto" style="width:250px">
        <el-form-item label="时间:" prop="date">
