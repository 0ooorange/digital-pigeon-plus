  ...
  <div class="container">
    ...
    >
      ...
      >
        ...
        <el-form-item label="规格:" prop="specs" :rules="formRules.specs[index]">
          <el-row :gutter="10">
            <el-col
              :span="8"
...
export default defineComponent({
  ...
  setup() {
    ...
    let fodderCate = reactive([{label:"鸽料138",value:"鸽料138",specs:"80kg/包"},{label:"中料",value:"中料",specs:"40kg/包"}]);
    ...
    const specsChange=(index)=>{
      addInfo.specs[index]=fodderCate[]
    }
    const formRules = ref({
