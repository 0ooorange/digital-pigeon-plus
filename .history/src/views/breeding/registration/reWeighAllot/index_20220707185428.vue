<template>
  <div class="container">
    <div class="tag">
      <el-button type="primary" plain @click="addWeightAllotdialog = true"
        >添加出栏</el-button
      >
      <table-search
        ...
        <el-table-column label="操作" width="220" align="center" fixed="right">
          <template #default="scope">
            <el-button
              ...
              text
              icon="el-icon-edit"
              @click="showWeightAllotdialog(scope.row)"
              >编辑</el-button
            >
            <el-button
              size="mini"
              ...
              text
              icon="el-icon-delete"
              @click="removeWeightAllot(scope.row.id)"
              >删除</el-button
            >
          </template>
        </el-table-column>
    ...
    >
      ...
      <span class="dialog-footer">
        <el-button @click="addWeightAllotdialog = false">取 消</el-button>
        <el-button type="primary" plain @click="addWeightAllot()">确 定</el-button>
      </span>
    </el-dialog>
    <el-dialog
      title="编辑出栏"
      v-model="WeightAllotdialog"
      width="25%"
    ...
    >
      ...
      <span class="dialog-footer">
        <el-button @click="WeightAllotdialog = false">取 消</el-button>
        <el-button type="primary" plain @click="updateWeightAllot()"
          >确 定</el-button
        >
      </span>
    </el-dialog>
...
export default defineComponent({
  ...
  setup() {
    ...
    let addWeightAllotdialog = ref(false);
    let WeightAllotdialog = ref(false);
  ...
  const printTable = () => {
    ...
    //把这一行的信息传入对话框
    const showWeightAllotdialog = (item) => {
      WeightAllotdialog.value = true;
      editInfo.value = item;
    };
    const updateWeightAllot = () => {
      console.log("更改");
      WeightAllotdialog.value = false;
    };
    const removeWeightAllot = () => {
      console.log("删除");
    };
    const addWeightAllot = () => {
      /*  tableData.value.push(addInfo.value); */
      addWeightAllotdialog.value = false;
    };
