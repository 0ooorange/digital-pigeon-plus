<template>
  <div class="container">
    <div class="tag">
      <el-button type="primary" plain @click="addWdialog = true"
        >添加出栏</el-button
      >
      <table-search
    ...
    >
      ...
      <span class="dialog-footer">
        <el-button @click="addWdialog = false">取 消</el-button>
        <el-button type="primary" plain @click="addW()">确 定</el-button>
      </span>
    </el-dialog>
    <el-dialog
      title="编辑出栏"
    ...
    >
      ...
      <span class="dialog-footer">
        <el-button @click="Wdialog = false">取 消</el-button>
        <el-button type="primary" plain @click="updateW()"
          >确 定</el-button
        >
      </span>
    </el-dialog>
...
export default defineComponent({
  ...
  setup() {
    ...
    let addWdialog = ref(false);
    let Wdialog = ref(false);
