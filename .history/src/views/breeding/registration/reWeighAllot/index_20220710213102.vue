...
export default defineComponent({
  ...
  setup() {
    ...
    const api = proxy.$API.regReWeight.getfeed;
    const params = {
    ...
    const addReWeight = () => {
      proxy.$refs.addRef.validate(async (valid) => {
        ...
        await proxy.$API.regReWeight.addfeed.post(addInfo.value).then((res) => {
          if (res.success) {
            proxy.$message({
              message: "添加成功",
              type: "success",
    ...
    const updateReWeight = () => {
      proxy.$refs.editRef.validate(async (valid) => {
        ...
        await proxy.$API.regReWeight.modifyfeed
          .post(editInfo.value)
          .then((res) => {
            if (res.success) {
              proxy.$message({
    ...
    const removeReWeight = async (id) => {
      ...
      await proxy.$API.regReWeight.deletefeed.post(id).then((res) => {
        if (res.success) {
          proxy.$message({
            message: "删除成功",
            type: "success",
