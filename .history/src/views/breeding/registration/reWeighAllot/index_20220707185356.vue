<template>
  <div class="container">
    <div class="tag">
      <el-button type="primary" plain @click="addWedialog = true"
        >添加出栏</el-button
      >
      <table-search
    ...
    >
      ...
      <span class="dialog-footer">
        <el-button @click="addWedialog = false">取 消</el-button>
        <el-button type="primary" plain @click="addWe()">确 定</el-button>
      </span>
    </el-dialog>
    <el-dialog
      title="编辑出栏"
    ...
    >
      ...
      <span class="dialog-footer">
        <el-button @click="Wedialog = false">取 消</el-button>
        <el-button type="primary" plain @click="updateWe()"
          >确 定</el-button
        >
      </span>
    </el-dialog>
...
export default defineComponent({
  ...
  setup() {
    ...
    let addWedialog = ref(false);
    let Wedialog = ref(false);
  ...
  const printTable = () => {
    ...
    //把这一行的信息传入对话框
    const showWedialog = (item) => {
      Wedialog.value = true;
      editInfo.value = item;
    };
    const updateWe = () => {
      console.log("更改");
      Wedialog.value = false;
    };
    const removeWe = () => {
      console.log("删除");
    };
