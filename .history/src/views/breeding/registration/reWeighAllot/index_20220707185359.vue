<template>
  <div class="container">
    <div class="tag">
      <el-button type="primary" plain @click="addWeightdialog = true"
        >添加出栏</el-button
      >
      <table-search
        ...
        <el-table-column label="操作" width="220" align="center" fixed="right">
          <template #default="scope">
            <el-button
              ...
              text
              icon="el-icon-edit"
              @click="showWeightdialog(scope.row)"
              >编辑</el-button
            >
            <el-button
              size="mini"
              ...
              text
              icon="el-icon-delete"
              @click="removeWeight(scope.row.id)"
              >删除</el-button
            >
          </template>
        </el-table-column>
    ...
    >
      ...
      <span class="dialog-footer">
        <el-button @click="addWeightdialog = false">取 消</el-button>
        <el-button type="primary" plain @click="addWeight()">确 定</el-button>
      </span>
    </el-dialog>
    <el-dialog
      title="编辑出栏"
    ...
    >
      ...
      <span class="dialog-footer">
        <el-button @click="Weightdialog = false">取 消</el-button>
        <el-button type="primary" plain @click="updateWeight()"
          >确 定</el-button
        >
      </span>
    </el-dialog>
