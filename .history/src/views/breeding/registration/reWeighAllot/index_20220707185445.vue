<template>
  <div class="container">
    <div class="tag">
      <el-button type="primary" plain @click="addredialog = true"
        >添加出栏</el-button
      >
      <table-search
    ...
    >
      ...
      <span class="dialog-footer">
        <el-button @click="addredialog = false">取 消</el-button>
        <el-button type="primary" plain @click="addre()">确 定</el-button>
      </span>
    </el-dialog>
    <el-dialog
      title="编辑出栏"
    ...
    >
      ...
      <span class="dialog-footer">
        ...
        <el-button type="primary" plain @click="updatere()"
          >确 定</el-button
        >
      </span>
    </el-dialog>
...
export default defineComponent({
  ...
  setup() {
    ...
    let addredialog = ref(false);
    let redialog = ref(false);
