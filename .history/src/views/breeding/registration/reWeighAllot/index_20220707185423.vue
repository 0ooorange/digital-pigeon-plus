<template>
  <div class="container">
    <div class="tag">
      <el-button type="primary" plain @click="addWeightALLdialog = true"
        >添加出栏</el-button
      >
      <table-search
        ...
        <el-table-column label="操作" width="220" align="center" fixed="right">
          <template #default="scope">
            <el-button
              ...
              text
              icon="el-icon-edit"
              @click="showWeightALLdialog(scope.row)"
              >编辑</el-button
            >
            <el-button
              size="mini"
              ...
              text
              icon="el-icon-delete"
              @click="removeWeightALL(scope.row.id)"
              >删除</el-button
            >
          </template>
        </el-table-column>
    ...
    >
      ...
      <span class="dialog-footer">
        <el-button @click="addWeightALLdialog = false">取 消</el-button>
        <el-button type="primary" plain @click="addWeightALL()">确 定</el-button>
      </span>
    </el-dialog>
    <el-dialog
      title="编辑出栏"
      v-model="WeightALLdialog"
      width="25%"
    ...
    >
      ...
      <span class="dialog-footer">
        <el-button @click="WeightALLdialog = false">取 消</el-button>
        <el-button type="primary" plain @click="updateWeightALL()"
          >确 定</el-button
        >
      </span>
    </el-dialog>
...
export default defineComponent({
  ...
  setup() {
    ...
    let addWeightALLdialog = ref(false);
    let WeightALLdialog = ref(false);
  ...
  const printTable = () => {
    ...
    //把这一行的信息传入对话框
    const showWeightALLdialog = (item) => {
      WeightALLdialog.value = true;
      editInfo.value = item;
    };
    const updateWeightALL = () => {
      console.log("更改");
      WeightALLdialog.value = false;
    };
    const removeWeightALL = () => {
      console.log("删除");
    };
    const addWeightALL = () => {
      /*  tableData.value.push(addInfo.value); */
      addWeightALLdialog.value = false;
    };
