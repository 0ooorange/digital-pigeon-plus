<template>
  <div class="container">
    <div v-show="isSearch" class="top">
        ...
        <el-form label-width="60px" :model="searchInfo" ref="searchRef">
          <el-row :gutter="10">
            ...
            <el-form-item label="鸽棚:" prop="dovecoteNumber">
              <el-select
                v-model="searchInfo.dovecoteNumber"
                placeholder="请选择"
              >
                <el-option
            ...
            <el-form-item label="去向:" prop="go">
              <el-input
                v-model="searchInfo.go"
                placeholder="请输入去向"
              ></el-input>
            </el-form-item>
            <el-form-item label="单据号:" prop="billNum">
              <el-input
                v-model="searchInfo.billNum"
                placeholder="请输入单据号"
              ></el-input>
            </el-form-item>
            <el-form-item label="批次号:" prop="batchNum">
              <el-input
                v-model="searchInfo.batchNum"
                placeholder="请输入批次号"
              ></el-input>
            </el-form-item>
          </el-row>
      ...
      <span class="submit">
        <el-button type="primary" plain @click="searchOutcage()"
          >搜索</el-button
        >
    ...
    >
      ...
      >
        ...
        <el-form-item label="种类:" prop="cate">
          <el-input
            v-model="OutcageInfo.cate"
            placeholder="请输入种类"
          ></el-input>
        </el-form-item>
        <el-form-item label="数量:" prop="number">
          <el-input
            v-model="OutcageInfo.number"
            placeholder="请输入数量"
          ></el-input>
        </el-form-item>
        <el-form-item label="去向:" prop="go">
          <el-input
            v-model="OutcageInfo.go"
            placeholder="请输入去向"
          ></el-input>
        </el-form-item>
        <el-form-item label="单据号:" prop="billNum">
          <el-input
            v-model="OutcageInfo.billNum"
            placeholder="请输入单据号"
          ></el-input>
        </el-form-item>
        <el-form-item label="批次号:" prop="batchNum">
          <el-input
            v-model="OutcageInfo.batchNum"
            placeholder="请输入批次号"
          ></el-input>
        </el-form-item>
      </el-form>
