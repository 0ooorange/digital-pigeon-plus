<template>
  <div class="container">
    ...
    >
      ...
      >
        <el-form-item label="时间:" prop="deliverTime">
          <el-input v-model="addInfo.deliverTime" placeholder="请输入时间"></el-input>
        </el-form-item>
        ...
        <el-form-item label="种类:" prop="category">
          <el-input v-model="addInfo.category" placeholder="请输入种类"></el-input>
        </el-form-item>
        ...
        <el-form-item label="去向:" prop="destination">
          <el-input v-model="addInfo.destination" placeholder="请输入去向"></el-input>
        </el-form-item>
    ...
    >
      ...
      >
        <el-form-item label="时间:" prop="deliverTime">
          <el-input v-model="editInfo.deliverTime" placeholder="请输入时间"></el-input>
        </el-form-item>
        <el-form-item label="鸽棚:" prop="shedId">
        ...
        <el-form-item label="种类:" prop="category">
          <el-input v-model="editInfo.category" placeholder="请输入种类"></el-input>
        </el-form-item>
        <el-form-item label="数量:" prop="num">
          <el-input
        ...
        <el-form-item label="去向:" prop="destination">
          <el-input v-model="editInfo.destination" placeholder="请输入去向"></el-input>
        </el-form-item>
        <el-form-item label="单据号:" prop="codes">
          <el-input
...
export default defineComponent({
  ...
  setup() {
    ...
    const removeOutcage = () => {
        proxy.$API.regOutCage.deletedeliver.post(editInfo.value.id).then((res) => {
              if (res.success) {
                proxy.$message({
                  message: "删除成功",
                  type: "success",
