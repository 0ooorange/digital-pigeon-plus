<template>
  <div class="container">
    ...
    <el-main class="main">
      <scTable :data="tableData" stripe highlightCurrentRow :apiObj="api" :params="params" :requestMethods="post">
        <el-table-column
          prop="date"
          label="时间"
          width="120"
...
export default defineComponent({
  ...
  setup() {
    ...
    const params = {startTime:datePk[0],endTime:datePk[1],shedId:'1518124016571797507'};
    return {
      tableData,
      addInfo,
      addOutcagedialog,
