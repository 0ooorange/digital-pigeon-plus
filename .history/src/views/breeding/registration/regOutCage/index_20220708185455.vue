...
export default defineComponent({
  ...
  setup() {
    ...
    const formRules = ref({
      ...
      dovecoteNumber: [{ message: "请输入鸽peng", trigger: "blur" ,required: true,}],
      cate: [{ message: "请输入时间", trigger: "blur" ,required: true,}],
      number: [{ message: "请输入时间", trigger: "blur" ,required: true,}],
      go: [{ message: "请输入时间", trigger: "blur" ,required: true,}],
      billNum: [{ message: "请输入时间", trigger: "blur" ,required: true,}],
      batchNum: [{ message: "请输入时间", trigger: "blur",required: true, }],
    });
    // 设置默认时间段，组件内默认半年
    let end = new Date();
    let start = new Date();
