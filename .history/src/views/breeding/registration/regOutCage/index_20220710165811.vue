  ...
  setup() {
    ...
    const addOutcage = () => {
      proxy.$refs.addRef.validate(async (valid) => {
        ...
        await proxy.$API.regOutCage.adddeliver.post(addInfo.value).then((res) => {
          if (res.success) {
            proxy.$message({
              message: "添加成功",
              type: "success",
    ...
    const updateOutcage = () => {
      proxy.$refs.editRef.validate(async (valid) => {
        ...
        await proxy.$API.regOutCage.modifydeliver.post(editInfo.value).then((res) => {
          if (res.success) {
            proxy.$message({
              message: "修改成功",
              type: "success",
    ...
    const removeOutcage = async (id) => {
      ...
      proxy.$API.regOutCage.deletedeliver.post(id).then((res) => {
        if (res.success) {
          proxy.$message({
            message: "删除成功",
            type: "success",
