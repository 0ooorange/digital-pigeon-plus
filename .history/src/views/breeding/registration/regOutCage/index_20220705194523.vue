    ...
    <div v-show="isSearch" class="top">
      ...
      <el-form label-width="60px" :model="searchInfo" ref="searchRef">
        <el-row :gutter="10">
          ...
          <el-form-item label="种类:" prop="cate" placeholder="请输入种类">
            <el-input v-model="searchInfo.cate"></el-input>
          </el-form-item>
          <el-form-item label="数量:" prop="number" placeholder="请输入数量">
            <el-input v-model="searchInfo.number"></el-input>
          </el-form-item>
          <el-form-item label="去向:" prop="go" placeholder="请输入去向">
            <el-input v-model="searchInfo.go"></el-input>
          </el-form-item>
          <el-form-item label="单据号:" prop="billNum" placeholder="请输入单据号">
            <el-input v-model="searchInfo.billNum"></el-input>
          </el-form-item>
          <el-form-item label="批次号:" prop="batchNum" placeholder="请输入批次号">
