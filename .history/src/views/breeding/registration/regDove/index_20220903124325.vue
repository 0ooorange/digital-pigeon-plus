  ...
  <div class="container">
    ...
    >
      ...
      >
        ...
        <el-form-item label="种类:" prop="description">
          ...
          </el-select><el-input v-model="addInfo.description" placeholder="请输入种类"></el-input>
        </el-form-item>
    ...
    >
      ...
      >
        ...
        <el-form-item label="种类:" prop="description">
          <el-input v-model="editInfo.description" placeholder="请输入鸽龄"></el-input>
        </el-form-item>
        <el-form-item label="鸽龄(天):" prop="age">
...
export default defineComponent({
  ...
  setup() {
    ...
    let description = reactive(["鸽料138", "混料"]);
    const reset = () => {
      // console.log("点击重置");
    };
    const outTable = () => {
