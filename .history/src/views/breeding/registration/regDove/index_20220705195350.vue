<template>
  <div class="container">
      ...
      <el-form label-width="60px" :model="searchInfo" ref="searchRef">
        <el-row :gutter="10">
          ...
          <el-form-item label="鸽笼号" prop="DoveNum">
            <el-input v-model="searchInfo.cate" placeholder="请输入ge'lon"></el-input>
          </el-form-item>
        </el-row>
      </el-form>
      </div>
    ...
    >
      ...
      >
        ...
        <el-form-item label="批次号:" prop="batchNum">
          <el-input v-model="addInfo.batchNum" placeholder="请输入批次号"></el-input>
        </el-form-item>
      </el-form>
    ...
    >
      ...
      >
        <el-form-item label="时间:" prop="date">
          <el-input v-model="OutcageInfo.date" placeholder="请输入时间"></el-input>
        </el-form-item>
        <el-form-item label="鸽棚:" prop="dovecoteNumber">
        ...
        <el-form-item label="种类:" prop="cate">
          <el-input v-model="OutcageInfo.cate" placeholder="请输入种类"></el-input>
        </el-form-item>
        <el-form-item label="数量:" prop="number">
          <el-input v-model="OutcageInfo.number" placeholder="请输入数量"></el-input>
        </el-form-item>
        <el-form-item label="去向:" prop="go">
          <el-input v-model="OutcageInfo.go" placeholder="请输入去向"></el-input>
        </el-form-item>
        <el-form-item label="单据号:" prop="billNum">
          <el-input v-model="OutcageInfo.billNum" placeholder="请输入单据号"></el-input>
        </el-form-item>
        <el-form-item label="批次号:" prop="batchNum">
          <el-input v-model="OutcageInfo.batchNum" placeholder="请输入批次号"></el-input>
        </el-form-item>
      </el-form>
      <span class="dialog-footer">
