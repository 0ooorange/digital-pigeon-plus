    ...
    <div class="container">
            <div>
                <el-card class="mini_card">
                    ...
                    <span style=" color:#EE4000">234对</span>
                </el-card>
            </div>
            <div>
                <el-card class="mini_card">
                    <span class="fontcolor">幼鸽数:</span>
                    <span style="color:#EE9A49">234对</span>
                </el-card>
            </div>
            <div >
                <el-card class="mini_card">
                    <span class="fontcolor">抽蛋数:</span>
                    <span style="color:#7D26CD">234对</span>
                </el-card>
            </div>
            <div>
                <el-card class="mini_card">
                    <span class="fontcolor"> 产蛋数：</span>
                     <span style="color: #43CD80">234对</span>
                </el-card>
            </div>
             <div >
                <el-card class="mini_card">
                    <span class="fontcolor">出仔数：</span>
                    <span style="color:#76EE00">234对</span>
                </el-card>
            </div> <div>
                <el-card class="mini_card"> 
                    <span class="fontcolor">出栏数：</span>          
                    <span style="color: #6495ED">234对</span>
                </el-card>
            </div> 
            <div >
                <el-card class="mini_card">
