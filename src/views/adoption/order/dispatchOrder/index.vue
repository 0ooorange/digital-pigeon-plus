<template>
    <el-main>
        <scTable :data="dataList" stripe :hidePagination="true">
            ...
            <el-table-column prop="goodsName" header-align="center" align="center" label="商品">
            </el-table-column>
            <el-table-column prop="number" header-align="center" align="center" label="商品数量">
            </el-table-column>
            <el-table-column prop="price" header-align="center" align="center" label="商品单价">
            </el-table-column>
            <el-table-column prop="totalPrice" header-align="center" align="center" label="订单总额">
            </el-table-column>
            ...
            <el-table-column prop="province" header-align="center" align="center" label="省份/直辖市">
            </el-table-column>
            ...
            <el-table-column prop="detail" header-align="center" align="center" label="详细地址">
            </el-table-column>
            <el-table-column prop="mtime" header-align="center" align="center" label="修改时间">
            </el-table-column>
...
const getDataList = () => {
    http({
        url: http.adornUrl('/order/dispatchorder/list'),
        method: "get",
...
const deleteHandle = (id) => {
    ...
    http({
        url: http.adornUrl('/order/dispatchorder/delete'),
        method: "delete",
