<template>
    <el-main>
        ...
        <scTable :data="dataList" stripe :hidePagination="true">
            ...
            <el-table-column prop="categoryName" header-align="center" align="center" label="分类名称">
            </el-table-column>
...
const getDataList = () => {
    http({
        url: http.adornUrl("/shop/goodsCategory/list"),
        method: "get",
...
const deleteHandle = (id) => {
    ...
    http({
        url: http.adornUrl("/shop/goodsCategory/delete"),
        method: "delete",
