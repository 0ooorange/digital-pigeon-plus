<template>
    ...
    <el-table :data="dataList" size="small" stripe v-loading="dataListLoading" @selection-change="selectionChangeHandle"
        ...
        <el-table-column prop="category" header-align="center" align="center" label="分类">
        </el-table-column>
        <el-table-column prop="title" header-align="center" align="center" label="标题">
        </el-table-column>
        <el-table-column prop="content" header-align="center" align="center" label="内容" show-overflow-tooltip>
        </el-table-column>
...
const getDataList = () => {
    http({
        url: http.adornUrl("/staticinfo/science/list"),
        method: "get",
