...
<template>
  <div class="main">
    ...
    <scTable :data="tableData" stripe>
      ...
      <el-table-column prop="longitude" label="精度" sortable align="center" />
      <el-table-column prop="introduction" label="基地介绍" align="center" show-overflow-tooltip />
  ...
  setup(){
    ...
    const showPage_methods = {
      async getAllBaseInfo() {
		...
		showPage_state.tableData = res.data.baseList
      },
    };
	return{
