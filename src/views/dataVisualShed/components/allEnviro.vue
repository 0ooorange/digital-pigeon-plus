// 环境统计
<template>
  <ScEcharts :option="environmentOption" height="85%" width="90%"></ScEcharts>
</template>
<script setup>
...
// 获取传感器数据
const shed_id = store.state.baseInfo.SHED_ID
getSensorByIDTypeTime(shed_id, '空气温度', dateFormat(props.start_time), dateFormat(props.end_time)).then((res) => {
...
getSensorByIDTypeTime(shed_id, '空气湿度', dateFormat(props.start_time), dateFormat(props.end_time)).then((res) => {
  let num = parseInt(res.data.data.length / 6)
  let valueArr = []
  for (let i = 0; i < num * 6; i += num) { valueArr.push(res.data.data[i].datavalue) }
  valueArr.push(res.data.data[res.data.data.length - 1].datavalue)
...
getSensorByIDTypeTime(shed_id, '光照强度', dateFormat(props.start_time), dateFormat(props.end_time)).then((res) => {
  let num = parseInt(res.data.data.length / 6)
  let valueArr = []
  for (let i = 0; i < num * 6; i += num) { valueArr.push(res.data.data[i].datavalue) }
  valueArr.push(res.data.data[res.data.data.length - 1].datavalue)
...
getSensorByIDTypeTime(shed_id, '二氧化碳', dateFormat(props.start_time), dateFormat(props.end_time)).then((res) => {
  let num = parseInt(res.data.data.length / 6)
  let valueArr = []
  for (let i = 0; i < num * 6; i += num) { valueArr.push(res.data.data[i].datavalue) }
  valueArr.push(res.data.data[res.data.data.length - 1].datavalue)
...
getSensorByIDTypeTime(shed_id, '氨气浓度', dateFormat(props.start_time), dateFormat(props.end_time)).then((res) => {
  let num = parseInt(res.data.data.length / 6)
  let valueArr = []
  for (let i = 0; i < num * 6; i += num) { valueArr.push(res.data.data[i].datavalue) }
  valueArr.push(res.data.data[res.data.data.length - 1].datavalue)
...
getSensorByIDTypeTime(shed_id, '硫化氢', dateFormat(props.start_time), dateFormat(props.end_time)).then((res) => {
  let num = parseInt(res.data.data.length / 6)
  let valueArr = []
  for (let i = 0; i < num * 6; i += num) { valueArr.push(res.data.data[i].datavalue) }
  valueArr.push(res.data.data[res.data.data.length - 1].datavalue)
...
getSensorByIDTypeTime(shed_id, '噪音', dateFormat(props.start_time), dateFormat(props.end_time)).then((res) => {
  let num = parseInt(res.data.data.length / 6)
  let valueArr = []
  for (let i = 0; i < num * 6; i += num) { valueArr.push(res.data.data[i].datavalue) }
  valueArr.push(res.data.data[res.data.data.length - 1].datavalue)
